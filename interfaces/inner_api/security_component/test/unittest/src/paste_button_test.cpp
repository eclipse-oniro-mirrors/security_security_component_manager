...
{
    jsonComponent[JSON_SC_TYPE] = PASTE_COMPONENT;
    ...
    jsonComponent[JSON_STYLE_TAG] = nlohmann::json {
        { JSON_TEXT_TAG, PasteDesc::PASTE },
        { JSON_ICON_TAG, PasteIcon::LINE_ICON },
...
nlohmann::json jsonComponent;
    ...
    jsonComponent[JSON_STYLE_TAG] = nlohmann::json {
        { JSON_TEXT_TAG, PasteDesc::UNKNOWN_TEXT },
        { JSON_ICON_TAG, PasteIcon::LINE_ICON },
        { JSON_BG_TAG, SecCompBackground::CIRCLE },
    };
    ...
    jsonComponent[JSON_STYLE_TAG] = nlohmann::json {
        { JSON_TEXT_TAG, PasteDesc::PASTE},
        { JSON_ICON_TAG, PasteIcon::UNKNOWN_ICON },
        { JSON_BG_TAG, SecCompBackground::CIRCLE },
    };
    ASSERT_FALSE(button.FromJson(jsonComponent));
    ...
    jsonComponent[JSON_STYLE_TAG] = nlohmann::json {
        { JSON_TEXT_TAG, PasteDesc::MAX_LABEL_TYPE },
        { JSON_ICON_TAG, PasteIcon::LINE_ICON },
        { JSON_BG_TAG, SecCompBackground::CIRCLE },
    };
    ASSERT_FALSE(button.FromJson(jsonComponent));
    ...
    jsonComponent[JSON_STYLE_TAG] = nlohmann::json {
        { JSON_TEXT_TAG, PasteDesc::PASTE },
        { JSON_ICON_TAG, PasteIcon::MAX_ICON_TYPE },
        { JSON_BG_TAG, SecCompBackground::CIRCLE },
    };
    ASSERT_FALSE(button.FromJson(jsonComponent));
