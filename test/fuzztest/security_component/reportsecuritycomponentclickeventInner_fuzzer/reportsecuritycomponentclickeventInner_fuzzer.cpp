...
#include "reportsecuritycomponentclickeventInner_fuzzer.h"

using namespace OHOS::Security::SecurityComponent;
using namespace OHOS::Security::AccessToken;
namespace OHOS {
static void ReportSecurityComponentClickEventInnerFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::ReportSecurityComponentClickEventInnerFuzzTest(data, size);
    return 0;
}
